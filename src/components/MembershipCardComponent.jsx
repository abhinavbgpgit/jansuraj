...
export default function MembershipCardComponent({ member = {} }) {
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-slate-100 bg-white/60 p-4 shadow-md">
      <div className="flex items-center gap-4">
        {photo ? (
          <img
            src={photo}
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <button className="rounded-full bg-sky-600 px-3 py-2 text-xs text-white">
          Download PNG
        </button>
      </div>
    </div>
