          ...
          <div className="rounded-3xl border border-sky-100 bg-sky-50 p-5">
            {!isCreator && creatorChecked && (
              <>
                ...
                <p className="mt-1 text-xs leading-5 text-sky-700">
                  अगर यह वही समस्या है, तो इसे support करें। अगर आपकी कोई अलग
                  समस्या है, तो नई समस्या दर्ज करें।
                </p>
              </>
            )}
            ...
            <div className="mt-3 flex items-center gap-2">
              <div className="flex items-center gap-2">
                <Link
                  to="/report"
                  className="inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-full bg-sky-600 px-4 py-2 text-xs font-semibold text-white transition hover:bg-sky-700"
                >
                  नई समस्या दर्ज करें →
                </Link>
